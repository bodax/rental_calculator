...
```bash
./gradlew run --args="\"E-Van, 95 km, 20 kWh, Motorway Vignette, Gubrist Tunnel x3\" \"Compact Van, 40 km, 5 liters\" \"Large Van, 180 km, 15 liters, City Congestion Fee 30 km city driving\""
```
